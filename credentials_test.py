...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_credentials = Credentials("twitter","melby","5657") # create credentials object
    def test_init(self):
        '''
        test_init test case to test if the object is initialized properly
        '''

        self.assertEqual(self.new_credentials.user_name1,"melby")
    ...
    def test_delete_credentials(self):
            ...
            '''
            self.new_credentials.save_credentials()
            test_credentials = Credentials("twitter","switz","6547") # new credentials
            test_credentials.save_credentials()
    ...
    def test_find_credentials_by_user_name1(self):
        ...
        self.new_credentials.save_credentials()
        test_credentials = Credentials("twitter","switz","6547") # new handle
        test_credentials.save_credentials()

        found_credentials = Credentials.find_by_user_name1("switz")
    ...
    def test_credentials_exists(self):
        ...
        self.new_credentials.save_credentials()
        test_credentials = Credentials("twitter","bosh","6579") # new credential
        test_credentials.save_credentials()

        credentials_exists = Credentials.credentials_exist("bosh")
